<!-- Footer -->
            ...
            <div class="grid lg:grid-cols-5 gap-12">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <p class="text-letcon-neutral-200 leading-relaxed max-w-md">
                        "Many drops make a lake." – Small contributions from many people create something great.
                    </p>
                    ...
                    <div class="flex space-x-4">
                        <a href="https://web.facebook.com/profile.php?id=61579779416308&sk" aria-label="Facebook"
                        ...
                        <a href="https://x.com/letconglobal" aria-label="Twitter"
                            class="w-10 h-10 bg-letcon-neutral-700 hover:gradient-hero rounded-lg flex items-center justify-center transition-all duration-300 hover:shadow-glow-primary">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://www.instagram.com/letconglobalcompany/" aria-label="Instagram"
                            class="w-10 h-10 bg-letcon-neutral-700 hover:gradient-hero rounded-lg flex items-center justify-center transition-all duration-300 hover:shadow-glow-primary">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://www.youtube.com/@LetconGlobalCompanyLTD" aria-label="YouTube"
                            class="w-10 h-10 bg-letcon-neutral-700 hover:gradient-hero rounded-lg flex items-center justify-center transition-all duration-300 hover:shadow-glow-primary">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('faq') }}"
                                class="text-letcon-neutral-200 hover:text-letcon-primary-light transition-colors duration-200">FAQ</a>
                        </li>
                        <li><a href="#contact"
    ...
    <!-- Back to Top Button -->
    <button id="backToTop"
        class="fixed bottom-8 right-8 bg-gradient-to-r from-blue-500 via-green-500 to-yellow-500 hover:from-blue-600 hover:via-green-600 hover:to-yellow-600 text-white p-3 rounded-full shadow-lg transition-all duration-300 opacity-0 invisible">
