                ...
                <div class="flex flex-col items-center">
                    <div wire:click="showUserDetails({{ $currentUser->id }})"
                        ...
                        @if ($currentUser->picture)
                            <img src="{{ storage_asset($currentUser->picture) }}" alt="Profile Photo"
                                ...
                                @foreach ($nodes['referrals'] as $referral)
                                    <div class="flex flex-col items-center">
                                        ...
                                        <div wire:click="showUserDetails({{ $referral->id }})"
                                            ...
                                            @if ($referral->picture)
                                                <img src="{{ storage_asset($referral->picture) }}"
                ...
                <div class="flex items-center mb-4">
                    <div
                        ...
                        @if ($selectedUser->picture)
                            <img src="{{ storage_asset($selectedUser->picture) }}" alt="Profile Photo"
                                class="w-full h-full object-cover">
                        @else
